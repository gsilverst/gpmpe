...
### Step 4: Edit Model and Chat-Driven Update Flow
Objective:
...
- Mandatory coverage areas: campaign CRUD flows, render pipeline, output-path handling, and edit flow validation.
